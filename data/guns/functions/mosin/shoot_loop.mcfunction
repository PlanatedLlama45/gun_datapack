...
execute unless entity @s[tag=played_ricochet] if score @s guns.shoot_distance >= mosin guns.MAX_DISTANCE run function guns:ricochet
execute unless entity @s[tag=played_ricochet] if score @s guns.shoot_pierced >= mosin guns.MAX_PIERCING run function guns:ricochet
