...
execute at @e[tag=pistol_barrel_craft_steel] if entity @e[distance=..0.5, tag=!pistol_barrel_craft] run tag @e remove pistol_barrel_craft
execute at @e[tag=pistol_barrel_craft_steel] if entity @e[distance=..0.5, tag=!pistol_barrel_craft] run tag @e remove pistol_barrel_craft_steel
