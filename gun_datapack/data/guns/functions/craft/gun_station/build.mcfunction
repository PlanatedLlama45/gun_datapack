...
execute as @e[tag=gun_station_build_black_steel] at @s align xyz run summon minecraft:armor_stand ~0.5 ~-1 ~0.5 {Invisible: 1b, Invulnerable: 1b, NoGravity: 1b, ArmorItems: [{}, {}, {}, {id: "barrier", Count: 1b, tag: {CustomModelData: 1001}}], Tags: ["gun_station"]}
