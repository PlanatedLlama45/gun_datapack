...
execute as @a[scores={rightClick=1.., shift=0}, nbt={SelectedItem: {tag: {Tags: ["gun"]}}}] if score @s guns.ammo matches 0 at @s run playsound minecraft:block.note_block.hat player @a ~ ~ ~ 2 1.5
