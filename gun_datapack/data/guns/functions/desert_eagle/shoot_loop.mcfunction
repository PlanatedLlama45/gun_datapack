...
execute if score @s guns.shoot_distance >= desert_eagle guns.MAX_DISTANCE run function guns:ricochet
execute if score @s guns.shoot_pierced >= desert_eagle guns.MAX_PIERCING run function guns:ricochet
