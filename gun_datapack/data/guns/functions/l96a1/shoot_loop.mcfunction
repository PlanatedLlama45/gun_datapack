...
execute if score @s guns.shoot_distance >= l96a1 guns.MAX_DISTANCE run function guns:ricochet
execute if score @s guns.shoot_pierced >= l96a1 guns.MAX_PIERCING run function guns:ricochet
